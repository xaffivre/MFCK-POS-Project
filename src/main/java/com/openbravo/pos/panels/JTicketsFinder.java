...
public class JTicketsFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    private void initComponents() {
        ...
        jtxtMoney.setFont(new java.awt.Font("MingLiu", 0, 14));
        jtxtMoney.setPreferredSize(new java.awt.Dimension(150, 30));

        jcboUser.setFont(new java.awt.Font("MingLiu", 0, 14));
        ...
        jcboMoney.setFont(new java.awt.Font("MingLiu", 0, 14));
        jcboMoney.setPreferredSize(new java.awt.Dimension(150, 30));

        jtxtTicketID.setFont(new java.awt.Font("MingLiu", 0, 12));
        jtxtTicketID.setPreferredSize(new java.awt.Dimension(150, 30));

        labelCustomer.setFont(new java.awt.Font("MingLiU", 0, 14));
        ...
        jTxtStartDate.setFont(new java.awt.Font("MingLiu", 0, 12));
        jTxtStartDate.setPreferredSize(new java.awt.Dimension(150, 30));

        jTxtEndDate.setFont(new java.awt.Font("MingLiu", 0, 12));
        ...
        jtxtCustomer.setFont(new java.awt.Font("MingLiu", 0, 12));
        ...
        jComboBoxTicket.setFont(new java.awt.Font("MingLiu", 0, 14));
        ...
        jbtnReset.setFont(new java.awt.Font("MingLiu", 0, 12));
        ...
        jbtnExecute.setFont(new java.awt.Font("MingLiu", 0, 12));
        ...
        jListTickets.setFont(new java.awt.Font("MingLiu", 0, 14));
        ...
        jcmdCancel.setFont(new java.awt.Font("MingLiu", 0, 12));
        ...
        jcmdOK.setFont(new java.awt.Font("MingLiu", 0, 12));
        ...
        jLblReturnCount.setFont(new java.awt.Font("MingLiu", 0, 14));
