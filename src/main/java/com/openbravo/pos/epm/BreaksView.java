...
public final class BreaksView extends javax.swing.JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        m_jBreakName.setFont(new java.awt.Font("MingLiU", 0, 12)); // NOI18N

        m_jBreakDescription.setColumns(20);
        m_jBreakDescription.setFont(new java.awt.Font("MingLiU", 0, 12)); // NOI18N
        ...
        m_Ncx.setFont(new java.awt.Font("MingLiU", 0, 12)); // NOI18N
        m_Ncx.setText(AppLocal.getIntString("label.epm.visible")); // NOI18N

        m_Name3.setFont(new java.awt.Font("MingLiU", 0, 12)); // NOI18N
        m_Name3.setText(AppLocal.getIntString("label.epm.notes")); // NOI18N

        jLabel1.setFont(new java.awt.Font("MingLiU", 0, 12)); // NOI18N
