...
public class JPanelConfiguration extends JPanel implements JPanelView {
	...
	*/
    private void initComponents() {
        ...
        jTabbedPane1.addTab("General一般設置", jPanelGeneral);
        ...
        jTabbedPane1.addTab("Locale內部設置", jPanelLocale);
...
*/
        ...
        jTabbedPane1.addTab("Peripherals外部設備", jPanelPeripheral);
        ...
        jTabbedPane1.addTab("System Options系統選項", jPanelSystem);
        ...
        jTabbedPane1.addTab("Invoice Setup發票設定", jPanelTicketSetup);
        ...
        jTabbedPane1.addTab("Company公司設定", jPanelCompany);
        ...
        jTabbedPane1.addTab("Database Setup資料庫設定", jPanelDatabase);
