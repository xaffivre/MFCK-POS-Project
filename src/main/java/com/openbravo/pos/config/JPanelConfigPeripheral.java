...
// iButton        
	...
	*/
    private void initComponents() {
		...
		webLbliButton.setVisible(false);
		webSlider.setVisible(false);
		webLabel1.setVisible(false);
		webLabel2.setVisible(false);
		webLabel3.setVisible(false);
		webSwtch_iButton.setVisible(false);
